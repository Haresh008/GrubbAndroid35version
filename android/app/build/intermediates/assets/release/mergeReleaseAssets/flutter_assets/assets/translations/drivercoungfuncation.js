...
const scheduleTime = orderData.scheduleTime;
if (scheduleTime && scheduleTime !== null) {
const scheduledTime = scheduleTime.toDate();
const currentTime = new Date();

const timeDifferenceInMinutes = (scheduledTime - currentTime) / (1000 * 60);
if (timeDifferenceInMinutes > 15 || timeDifferenceInMinutes < 0) {
console.log(`Order #${change.after.ref.id} is not within 15 minutes of scheduled time, skipping dispatch.`);
return null;
} else {
console.log(`Order #${change.after.ref.id} is within 15 minutes of scheduled time.`);
}
}
...
var kDistanceRadiusForDispatchInMiles = 0;
