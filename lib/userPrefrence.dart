...
class UserPreference {
  ...
  static getWalletData() {
    ...
    print("wallent ave ave ${isEnable}");
    return isEnable;
  }

  static setLightDarkThemeData(bool isEnable) async {
    await _preferences.setBool('lightDarkTheme', isEnable);
  }

  static getLightDarkThemeData() {
    final bool? isEnable = _preferences.getBool('lightDarkTheme');
    return isEnable != null ? isEnable : false;
  }
