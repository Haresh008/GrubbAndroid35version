...
String? validateConfirmPassword(String? password, String? confirmPassword) {
  if (password != confirmPassword) {
    return "password and Conform Password Not Match".tr();
...
Widget displayImage(String picUrl) => CachedNetworkImage(
  imageBuilder:
      (context, imageProvider) => _getFlatImageProvider(imageProvider),
...
Widget _getFlatPlaceholderOrErrorImage(bool placeholder) => Container(
  child:
      placeholder
          ...
          : Icon(Icons.error, color: Color(COLOR_PRIMARY)),
);
...
Widget displayCircleImage(String picUrl, double size, hasBorder) =>
    CachedNetworkImage(
      ...
      imageUrl: getImageVAlidUrl1(picUrl),
      placeholder:
          (context, url) => _getPlaceholderOrErrorImage(size, hasBorder),
      errorWidget:
          (context, url, error) => _getPlaceholderOrErrorImage(size, hasBorder),
    );
