...
PayPalClientSettleModel payPalClientSettleModelFromJson(String str) =>
    PayPalClientSettleModel.fromJson(json.decode(str));

String payPalClientSettleModelToJson(PayPalClientSettleModel data) =>
    json.encode(data.toJson());

class PayPalClientSettleModel {
  PayPalClientSettleModel({required this.success, required this.data});

  bool success;
  Data data;

  factory PayPalClientSettleModel.fromJson(Map<String, dynamic> json) =>
...
class Data {
  Data({required this.success, required this.transaction});
...
class Transaction {
  ...
  factory Transaction.fromJson(Map<String, dynamic> json) => Transaction(
    ...
    authorizationAdjustments: List<dynamic>.from(
      json["authorizationAdjustments"].map((x) => x),
    ),
    ...
    refundedInstallments: List<dynamic>.from(
      json["refundedInstallments"].map((x) => x),
    ),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "partialSettlementTransactionIds": List<dynamic>.from(
      partialSettlementTransactionIds.map((x) => x),
    ),
    ...
    "authorizationAdjustments": List<dynamic>.from(
      authorizationAdjustments.map((x) => x),
    ),
...
class At {
  At({required this.date, required this.timezoneType, required this.timezone});
