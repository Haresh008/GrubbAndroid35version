class DayamicCityHomeModal {
  ...
  factory DayamicCityHomeModal.fromJson(Map<String, dynamic> json) {
    return DayamicCityHomeModal(
      ...
      grubbMart: json['grubb_mart'] as String,
