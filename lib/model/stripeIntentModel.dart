...
class StripeCreateIntentModel {
  StripeCreateIntentModel({required this.success, required this.data});
...
class PaymentMethodOptions {
  ...
  factory PaymentMethodOptions.fromJson(Map<String, dynamic> json) =>
      PaymentMethodOptions(card: Card.fromJson(json["card"]));

  Map<String, dynamic> toJson() => {"card": card.toJson()};
}

class Card {
  Card({this.installments, this.network, required this.requestThreeDSecure});
