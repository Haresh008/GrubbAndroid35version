...
class PayPalCurrencyCodeErrorModel {
  PayPalCurrencyCodeErrorModel({required this.success, required this.data});
...
class Params {
  ...
  factory Params.fromJson(Map<String, dynamic> json) =>
      Params(transaction: ParamsTransaction.fromJson(json["transaction"]));
...
class Options {
  Options({required this.submitForSettlement});

  String submitForSettlement;

  factory Options.fromJson(Map<String, dynamic> json) =>
      Options(submitForSettlement: json["submitForSettlement"]);

  Map<String, dynamic> toJson() => {"submitForSettlement": submitForSettlement};
}
...
class DataTransaction {
  ...
  factory DataTransaction.fromJson(
