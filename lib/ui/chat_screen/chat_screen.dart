...
class _ChatScreensState extends State<ChatScreens> {
  ...
  _sendMessage(
    ...
    await FireStoreUtils.sendChatFcmMessageV1(
      title: widget.customerName.toString(),
  ...
  _onCameraClick() {
    final action = CupertinoActionSheet(
      message: Text('sendMedia', style: TextStyle(fontSize: 15.0)).tr(),
      actions: <Widget>[
        ...
        CupertinoActionSheetAction(
          ...
          onPressed: () async {
            Navigator.pop(context);
            XFile? galleryVideo = await _imagePicker.pickVideo(
              source: ImageSource.gallery,
            );
        ...
        CupertinoActionSheetAction(
          ...
          onPressed: () async {
            Navigator.pop(context);
            XFile? recordedVideo = await _imagePicker.pickVideo(
              source: ImageSource.camera,
            );
