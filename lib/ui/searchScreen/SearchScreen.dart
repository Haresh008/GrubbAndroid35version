...
import '../Grocery/Grocery_Products_Details_Screen.dart';
...
class SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    fireStoreUtils
        .getVendorsByCity(MyAppState.currentUser?.shippingAddress.city ?? "")
        .then((value) {
          setState(() {
            vendorList = value;
            print("kav karo ${vendorList.length}");
          });
        });
  ...
  //   }
  //
  //   final vendorResults = vendorList
  //       .where((element) =>
  //       element.title.toLowerCase().contains(text.toLowerCase()))
  //       .toList();
  //
  //   final productResults = productList
  //       .where((element) =>
