...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  void initState() {
    ...
    print("widget.orderModel.item${widget.orderModel.item ?? ""}");
          ...
          if (snapshot.hasData) {
            ...
            switch (orderStatus) {
              ...
              case ORDER_STATUS_SHIPPED:
                currentEvent = 'Order is Assigned to Driver'.tr(
                  args: [
              ...
              case ORDER_STATUS_COMPLETED:
                currentEvent = 'Your order is Delivered.'.tr();
                break;
            }
  ...
  Widget buildOrderSummaryCard(OrderModel orderModel) {
      ...
      for (var element in taxList!) {
        taxAmount =
            (double.parse(taxAmount) +
                    num.parse(orderModel.packingcharges.toString()) +
                    calculateTax(
                      amount:
    ...
    var deliveryCharge =
        widget.orderModel.deliveryCharge == null ||
            ...
            ? 0.0
            : double.parse(widget.orderModel.deliveryCharge!);
    var adjustedDeliveryCharge =
        (widget.orderModel.freeDelivery == true) ? 0.0 : deliveryCharge;
    var totalamount =
        total +
        double.parse(taxAmount) +
        ((orderModel.packingcharges == '')
            ? 0.0
            : num.parse(orderModel.packingcharges.toString())) +
        adjustedDeliveryCharge +
        tipValue -
        discount -
        specialDiscountAmount;

    print("totalamounttotalamount${totalamount}");
    return Padding(
          ...
          child: Column(
            ...
            children: [
                                      ...
                                      child: Text(
                                        widget
                                            ...
                                            ? (widget
                                                    ...
                                                    .products[index]
                                                    .name +
                                                " (${widget.orderModel.products[index].groceryWeight} ${widget.orderModel.products[index].groceryUnit})")
                                            : widget
                                                .orderModel
                                                .products[index]
                                                .name,
                        ...
                        children: [
                          Expanded(
                            child: InkWell(
                              ...
                              //       .getProductByID(
                              //           widget.orderModel.products[index].id)
                              //       .then((value) {
                              //     productModel = value;
                              //   });
                              //
                              ...
                              //             id: widget.orderModel
                              //                     .products[index].id +
                              //                 "~" +
                              //                 (variantIno != null
                              //                     ? variantIno.variantId
                              //                         .toString()
                              //                     : ""),
                              //             name: widget.orderModel
                              //                 .products[index].name,
                              //             photo: widget.orderModel
                              //                 .products[index].photo,
                              //             price: widget.orderModel
                              //                 .products[index].price,
                              //             discountPrice: widget.orderModel
                              //                 .products[index].discountPrice,
                              //             vendorID: widget.orderModel
                              //                 .products[index].vendorID,
                              //             quantity: widget.orderModel
                              //                 .products[index].quantity,
                              //             extras_price: widget.orderModel
                              //                 .products[index].extras_price,
                              //             extras: widget.orderModel
                              //                 .products[index].extras,
                              //             category_id: widget.orderModel
                                ...
                                try {
                                  ...
                                  if (productModel!.itemAttributes != null) {
                                    ...
                                    if (productModel!.quantity >=
                                      ...
                                      if (_productIsInList) {
                                        CartProduct
                                        element = cartProducts.firstWhere(
                                          (product) =>
                                              product.id ==
                                              productModel!.id +
                                                  "~" +
              ...
              ListTile(
                ...
                trailing: Text(
                  "₹ ${widget.orderModel.packingcharges == "" ? "0.00" : widget.orderModel.packingcharges.toString()}",
                  style: TextStyle(
                    fontFamily: 'Poppinssm',
                    letterSpacing: 0.5,
                    fontSize: 16,
                    ...
                    onTap: () async {
                      ...
                      User? restaurantUser =
                          await FireStoreUtils.getCurrentUser(
                            widget.orderModel.vendor.author,
                          );
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: '{} is in {}'.tr(
                            args: [
                              (order.driver?.firstName ?? 'Our driver'.tr()),
              ...
              ListTile(
                leading: FloatingActionButton(
                  ...
                  backgroundColor:
                      ...
                      Colors.green,
                  elevation: 0,
                  child: const Icon(Icons.message, color: Color(0xFFFFFFFF)),
                ),
                title: GestureDetector(
                  child: Container(
                    padding: const EdgeInsets.symmetric(
...
//                   break;
//                 case ORDER_STATUS_SHIPPED:
//                   currentEvent = 'Order is Assigned to Driver'.tr(args: [
//                     (orderModel.driver?.firstName ?? 'Our Driver'.tr()),
//                     // '${orderModel.vendor.title}'
//                   ]);
//                   break;
...
//                                         if (productModel!.quantity >=
//                                                 widget.orderModel
//                                                     .admincommssionproducts[index].quantity ||
//                                             productModel!.quantity == -1) {
//                                           cartDatabase.reAddProduct(CartProduct(
//                                               id: widget.orderModel.admincommssionproducts[index].id +
//                                                   "~" +
//                                                   (variantIno != null
//                                                       ? variantIno.variantId
//                                                           .toString()
//                                                       : ""),
//                                               name: widget.orderModel
//                                                   .admincommssionproducts[index].name,
//                                               photo: widget.orderModel
//                                                   .admincommssionproducts[index].photo,
//                                               price: widget.orderModel
//                                                   .admincommssionproducts[index].price,
//                                               packingcharges: widget
//                                                   .orderModel
//                                                   .admincommssionproducts[index]
//                                                   .packingcharges,
...
//                                                   .discountPrice,
//                                               vendorID: widget.orderModel
//                                                   .admincommssionproducts[index].vendorID,
//                                               quantity: widget.orderModel
//                                                   .admincommssionproducts[index].quantity,
//                                               extras_price: widget.orderModel
//                                                   .admincommssionproducts[index].extras_price,
//                                               extras: widget.orderModel
//                                                   .admincommssionproducts[index].extras,
//                                               category_id: widget.orderModel
//                                                   .admincommssionproducts[index].category_id,
//                                               variant_info: variantIno));
//
//                                           await hideProgress();
//                                           ScaffoldMessenger.of(context)
...
//       amountShow(amount: total.toString()),
//       style: TextStyle(
//           fontSize: 20, color: Color(COLOR_PRIMARY), fontFamily: "Poppinsm"),
//     );
//   }
//
//   viewNotesheet(String notes) {
