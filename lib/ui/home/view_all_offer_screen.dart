        ...
        body: Column(
          children: [
            Stack(
              ...
              children: [
                Image(
                  image: const AssetImage("assets/images/offer_for_you.png"),
                  fit: BoxFit.cover,
                  height: 300,
              ...
              text: TextSpan(
                ...
                children: <TextSpan>[
                  ...
                  TextSpan(
                    text:
                        " & get".tr() +
                        " ${offerModel.discountType == "Fix Price" ? currencyModel!.symbol : ""}${offerModel.discount}${offerModel.discountType == "Percent" ? "% OFF" : "OFF"} ",
                    style: const TextStyle(
                      fontSize: 16.0,
                      color: Colors.grey,
                      fontWeight: FontWeight.w700,
            ...
            child: Stack(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "${offerModel.discountType == "Fix Price".tr() ? currencyModel!.symbol : ""}${offerModel.discount}${offerModel.discountType == "Percent" ? "% OFF" : "OFF"}",
                    style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                      letterSpacing: 0.7,
