...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    ...
    print("product Id ---->${widget.vendorModel.auto_apply}");
    print("product Id ---->${widget.vendorModel.auto_apply}");
    ...
    if (widget.productModel.disPrice == "0" &&
      ...
      setState(() {
        pricezero = true;
        print("id ave che viyo ja shu ave che ${pricezero}");
      });
    } else {
      setState(() {
        pricezero = false;
        print("else ave che  ja shu ave che ${pricezero}");
      });
    }
    widget.vendorModel.auto_apply == true
    ...
    print("isEnabled shu ave che${isEnabled}");
    print("isEnabled shu ave che${cityaveche}");
    print("isEnabled shu ave che${isMyTime}");
    print("isEnabled shu ave che${widget.vendorModel.auto_apply}");
    print("widget.producat price shu ave che ${widget.productModel.disPrice}");
    print("widget.producat price shu ave che ${widget.productModel.price}");
    getAddOnsData();
    statusCheck();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              isZeroOrEmpty(widget.productModel.price) &&
                                      isZeroOrEmpty(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  print(
                                    " lstAddAddonsCustom[index].addOnsType ?? "
                                    ",${lstAddAddonsCustom[index].addOnsType ?? ""}",
                                  );
                                  return Container(
                                            ...
                                            setState(() {
                                              ...
                                              lstAddAddonsCustom[index]
                                                  ...
                                                  !lstAddAddonsCustom[index]
                                                      .isCheck;
                                              print(
                                                "lstAddAddonsCustom[index] shu ave che =======??????${lstAddAddonsCustom[index].isCheck}",
                                              );
                                  ...
                                  if (isEnabled &&
                                    ...
                                    if (productModel.disPrice == "0") {
                                      ...
                                      zabalu =
                                          ...
                                          sameres;
                                      print(
                                        "finalprice>>>>>>>>>>>>>else ave che${finalprice}",
                                      );
                                      print(
                                        "finalprice>>>>>>>>>>>>> else price${priceaveche}",
                                      );
                                    }
                                  } else {
                                    print(
                                      "else call that che isenble check karva",
                                    );
                                  }
                                  return Container(
                                                    ...
                                                    productModel.disPrice ==
                                                        ...
                                                        ? isEnabled &&
                                                                ...
                                                                widget
                                                                    ...
                                                                    .auto_apply
                                                            ? Text(
                                                              "${amountShow(amount: zabalu.toString())}",
                                                              style: TextStyle(
                                                                fontFamily:
                                                                    "Poppinsm",
                                                                letterSpacing:
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 10),
                            child: Text(
                              "Similar from other restaurants ".tr(),
                              style: TextStyle(
                                fontFamily: "Poppinsm",
                                fontSize: 16,
                                color:
                ...
                if (MyAppState.currentUser == null) {
                  ...
                  if (productQnt == 0) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text("Please Add Quantity".tr())),
                    );
                  } else {
                    print("fdfd2");
                    pushAndRemoveUntil(
      ...
      //                         currentWidget: CartScreen(
      //                             packingCharge:
      //                                 widget.productModel.packingcharges),
      //                         appBarTitle: 'Your Cart'.tr(),
      //                       ),
      //                       false);
      //                 }
  ...
  addtocard(ProductModel productModel, bool isIncerementQuantity) async {
    ...
    for (int i = 0; i < lstTemp.length; i++) {
      ...
      if (addAddonsDemo.categoryID == widget.productModel.id) {
        ...
        print("addOnValaddOnValaddOnVal========>>>>>>>>>>${addOnVal}");
      }
    }
    ...
    if (productQnt >= 1) {
      ...
      if (!isAddSame) {
        if (productModel.disPrice != null &&
          ...
          mainPrice = productModel.disPrice!;
          print(
            "mainPricemainPricemainPricemainPricemainPricemainPrice${mainPrice}",
          );
        } else {
          mainPrice = productModel.price;
          print("else ma ave che${mainPrice}");
        }
      }
        ...
        if (widget.productModel.addOnsTitle.isNotEmpty) {
          for (int a = 0; a < widget.productModel.addOnsTitle.length; a++) {
            AddAddonsDemo addAddonsDemo = AddAddonsDemo(
              ...
              index: a,
              isCheck: false,
              addOnsType: widget.productModel.addOnsType[a],
      ...
      for (int d = 0; d < lstTemp.length; d++) {
        if (lstTemp[d].categoryID == widget.productModel.id) {
          AddAddonsDemo addAddonsDemo = AddAddonsDemo(
            ...
            isCheck: true,
            addOnsType: lstTemp[d].addOnsType,
  ...
  void clearAddOnData() {
    ...
    if (isAddOnApplied && addOnVal > 0 && productQnt > 0) {
      priceTemp -= (addOnVal * productQnt);
      print("isAddOnAppliedisAddOnApplied${isAddOnApplied}");
    }
  }
        ...
        for (int i = 0; i < cartProducts.length; i++) {
          ...
          if (widget.vendorModel.auto_apply == true) {
            ...
            if (e.quantity == 0) {
              ...
              print(
                "variyat vali producat ma priceTemp shu avve che ${priceTemp}",
              );
            }
...
class AddAddonsDemo {
  ...
  factory AddAddonsDemo.fromJson(Map<String, dynamic> jsonData) {
    return AddAddonsDemo(
      ...
      addOnsType: jsonData['addOnsType'],
