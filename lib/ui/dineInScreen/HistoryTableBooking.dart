...
class _HistoryTableBookingState extends State<HistoryTableBooking> {
  ...
  void initState() {
    ...
    bookedFuture = fireStoreUtils.getBookingOrders(
          ...
          if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
            return Center(
              child: showEmptyState(
                'No Previous Booking'.tr(),
                context,
                description: "Book Table".tr(),
              ),
            );
          } else {
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                  onTap: () {
                    push(
                      context,
                      TableOrderDetailsScreen(bookTableModel: bookTableModel),
                    );
                  },
                  child: Container(
