            ...
            if (orderModel.status == ORDER_STATUS_ACCEPTED) {
              ...
              mapMarkers.add(
                Marker(
                  ...
                  icon: storeIcon,
                  infoWindow: InfoWindow(title: orderModel.vendor.title),
                ),
              );
            ...
            child: Padding(
              ...
              child: Card(
                ...
                child: GoogleMap(
                  ...
                  onMapCreated:
                      (controller) => _onMapCreated(controller, orderModel),
                ),
              ),
            ),
          );
  ...
  void _onMapCreated(
    ...
    if (orderModel.status == ORDER_STATUS_IN_TRANSIT) {
      updateCameraLocation(
        ...
        LatLng(
          orderModel.author.location.latitude,
