...
class WalletScreenState extends State<WalletScreen> {
    ...
    await FireStoreUtils.createPaymentId().then((value) async {
      ...
      await FireStoreUtils.topUpWalletAmount(
        ...
        FireStoreUtils.updateWalletAmount(
          ...
          FireStoreUtils.sendAdminTopUpMail(
            paymentMethod: paymentMethod,
            amount: _amountController.text,
            tractionId: paymentID,
          );
                      ...
                      children: [
                        ...
                        Visibility(
                          visible:
                              ...
                              (mercadoPagoSettingData?.isEnabled ?? false),
                          child: Padding(
                            padding: const EdgeInsets.symmetric(
                              vertical: 4.0,
                              horizontal: 20,
                            ...
                            onTap: () async {
                              if (selectedRadioTile == "Stripe" &&
                                ...
                                PayStackURLGen.getPayHTML(
                                  ...
                                  bool isDone = await Navigator.of(
                                    context,
                                  ).push(
                                    MaterialPageRoute(
                                      builder:
  ...
  buildPaymentCard({
    required image,
    PaymentOptionString value = PaymentOptionString.Stripe,
  ...
  //
  //     var request = BraintreePayPalRequest(amount: _amountController.text, currencyCode: currencyModel!.code, billingAgreementDescription: "djsghxghf", displayName: 'Grubb company');
  ...
  createStripeIntent(String amount) async {
    stripe1.Stripe.publishableKey = stripeData!.clientpublishableKey.toString();
    try {
