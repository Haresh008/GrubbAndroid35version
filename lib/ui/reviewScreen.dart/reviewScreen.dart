...
class _ReviewScreenState extends State<ReviewScreen>
                                  ...
                                  return Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Expanded(
                                          child: Text(
                                            reviewAttributeList[index].title
                                                .toString(),
                                          ),
                                        ),
                                        RatingBar.builder(
                                          initialRating:
                                              reviewAttribute[reviewAttributeList[index]
                                                  .id] ??
                                              0.0,
                                          minRating: 1,
                                          direction: Axis.horizontal,
                ...
                ? Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      var error = await FireStoreUtils.updateProduct(
                        productModel!,
                      );
  ...
  savereview() async {
    if (comment.text == '' || ratings == 0) {
      showAlertDialog(
        context,
        'Please add All Field'.tr(),
        'All Field Reqired '.tr(),
        true,
      );
  ...
  _pickImage() {
    final action = CupertinoActionSheet(
      message:
          Text('Add Images'.tr(), style: const TextStyle(fontSize: 15.0)).tr(),
      actions: <Widget>[
