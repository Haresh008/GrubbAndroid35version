  ...
  Widget? get title {
    ...
    return AnimatedOpacity(
      ...
      child: Text(
        ...
        strutStyle: Helper.buildStrutStyle(textTheme.titleLarge),
      ),
    );
  }
  ...
  Widget? get flexibleSpace {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        print(
          "location shu ae che ${MyAppState.currentUser == null || MyAppState.currentUser?.userID == null || MyAppState.currentUser?.userID == ""
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        push(
                          context,
                          RestaurantPhotos(vendorModel: vendorModel),
                        );
                      },
                    ),
                  ),
                ...
                children: [
                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      child: Container(
                        padding: const EdgeInsets.only(right: 22, left: 2),
                        child:
                            Text(
                              "View Timing".tr(),
                              style: TextStyle(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                //  SizedBox(height: 5,),
                Text(
                  " " + formatTime(timeslot.from.toString()),
                  style: TextStyle(
                    fontFamily: "Poppinsm",
                    color:
                        isDarkMode(context)
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                //  SizedBox(height: 5,),
                Text(
                  " " + formatTime(timeslot.to.toString()),
                  style: TextStyle(
                    fontFamily: "Poppinsm",
                    color:
                        isDarkMode(context)
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        " ${offerList[index].discountType == "Fix Price" ? currencyModel!.symbol : ""}${offerList[index].discount} ${offerList[index].discountType == "Percent" ? "% OFF".tr() : "OFF".tr()} ",
                        style: const TextStyle(
                  ...
                  children: [
                    ...
                    Text(
                      "valid till".tr() +
                          " " +
                          getDate(
                            offerList[index].expireOfferDate!
                                .toDate()
                                .toString(),
                          )!,
                      style: const TextStyle(
                ...
                SizedBox(
                  ...
                  child: Text(
                    maxLines: 2,
                    offerList[index].descriptionOffer!,
                    textAlign: TextAlign.left,
                    style: const TextStyle(
                      fontSize: 13,
                      fontFamily: "Poppins",
  ...
  resttiming() {
    if (vendorModel.isTempClose) {
      return Container(
        ...
        child: Row(
          children: [
            const Icon(Icons.circle, color: Colors.redAccent, size: 13),
            const SizedBox(width: 10),
            Text(
              "Temporary Closed".tr(),
              style: const TextStyle(
      ...
      return Container(
        ...
        child: Row(
          children: [
            const Icon(Icons.circle, color: Color(0XFF3dae7d), size: 13),
            const SizedBox(width: 10),
            Text(
              "Open".tr(),
              style: const TextStyle(
    ...
    } else if (isPreOrderAvailable == true) {
      return Container(
        height: 35,
        decoration: const BoxDecoration(
          color: Color(0XFFF1F4F7),
